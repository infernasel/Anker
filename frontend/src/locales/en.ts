export default {
  ...
  'Friday': 'Fri',
  'Saturday': 'Sat',
  'Anker Computer': 'Anker Computer',
  'Anker is using': 'Anker is using',
  'Jump to live': 'Jump to live',
  'Failed to load file content': 'Failed to load file content',
  'Give Anker a task to work on...': 'Give Anker a task to work on...',
  // Shell tools
  ...
  'Archive': 'Archive',
  // Login/Register Page
  'Login to Anker': 'Login to Anker',
  'Register to Anker': 'Register to Anker',
  'Full Name': 'Full Name',
  'Email': 'Email',
  'Password': 'Password',
  ...
  'Registration successful! Welcome to Anker': 'Registration successful! Welcome to Anker',
